...
<section class="relative pt-24 pb-32 bg-white overflow-hidden">
    <div class="max-w-7xl mx-auto px-4 relative z-10 text-center">
        <span class="animate__animated animate__fadeInDown inline-block px-4 py-1.5 bg-blue-50 text-hero-blue text-[10px] font-black uppercase tracking-[0.2em] rounded-full mb-6">
        ...
        <h1 class="animate__animated animate__fadeInUp text-6xl md:text-7xl font-black tracking-tighter mb-8 leading-[0.95] text-hero-blue italic uppercase">
            Quality. <span class="animate__animated animate__fadeInUp animate__delay-1s text-hero-orange not-italic">Efficiency.</span> Excellence.
        </h1>
        <p class="animate__animated animate__fadeInUp animate__delay-2s text-xl text-gray-500 max-w-3xl mx-auto leading-relaxed font-medium">
...
<section class="py-24 bg-hero-blue text-white relative overflow-hidden">
    <div class="max-w-7xl mx-auto px-4 relative z-10">
        <div class="grid lg:grid-cols-2 gap-20 items-center">
            <div class="animate__animated animate__fadeInLeft space-y-12">
                <div>
            ...
            <div class="animate__animated animate__fadeInRight grid grid-cols-1 gap-6">
...
<section class="py-24 bg-white border-b border-gray-100">
    <div class="max-w-7xl mx-auto px-4">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div class="animate__animated animate__fadeInUp text-center group">
                ...
                <div class="flex items-center justify-center gap-2">
                    <img src="assets/img/favicon.ico" class="w-3 h-3 opacity-30" alt="Fav">
                    <p class="text-[10px] font-black uppercase text-gray-400 tracking-[0.3em]">Technical Nodes</p>
                </div>
            </div>

            <div class="animate__animated animate__zoomIn text-center group border-l border-gray-50 md:border-l-0">
    ...
    <div class="max-w-7xl mx-auto px-4 text-center">
        ...
        <div class="flex flex-wrap justify-center items-center gap-x-12 gap-y-10 opacity-50 grayscale hover:grayscale-0 transition-all duration-700">
            <?php 
                ...
                $i++;
            ?>
            <span class="animate__animated animate__fadeIn animate__delay-<?= $i % 5 ?>ms text-xl md:text-2xl font-black tracking-tighter text-hero-blue uppercase italic"><?= $client ?></span>
            <?php endforeach; ?>
        </div>
    </div>
</section>
