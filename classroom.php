...
<section class="relative pt-12 pb-20 bg-white border-b border-gray-100">
    <div class="max-w-7xl mx-auto px-4 text-center">
        <span class="animate__animated animate__fadeInDwn inline-block px-4 py-1.5 bg-blue-50 text-hero-blue text-[10px] font-black uppercase tracking-[0.3em] rounded-full mb-4">
...
<section class="py-16 bg-gray-50 border-y border-gray-100">
    <div class="max-w-7xl mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="animate__animated animate__fadeInLeft flex items-start gap-5 group">
            ...
            <div class="animate__animated animate__fadeInLeft animate__delay-1s flex items-start gap-5 group">
            ...
            <div class="animate__animated animate__fadeInLeft animate__delay-2s flex items-start gap-5 group">
                <div class="w-12 h-12 bg-hero-blue rounded-2xl flex items-center justify-center text-white shrink-0 shadow-lg shadow-blue-900/10">
...
<section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="space-y-4">
            ...
            ?>
            <div class="reveal animate__animated p-6 bg-white border border-gray-100 rounded-[2rem] shadow-sm flex flex-col md:flex-row items-center justify-between gap-6 group hover:border-hero-blue transition-all"
