...
<section class="relative pt-12 pb-20 bg-white border-b border-gray-100">
    <div class="max-w-7xl mx-auto px-4 text-center">
        <span class="animate__animated animate__fadeInDown inline-block px-4 py-1.5 bg-blue-50 text-hero-blue text-[10px] font-black uppercase tracking-[0.3em] rounded-full mb-4">
            Knowledge Base
        </span>
...
<section class="py-12 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4">
        <div class="animate__animated animate__fadeIn animate__delay-1s bg-white rounded-[2.5rem] border border-gray-200 overflow-hidden shadow-sm flex flex-col lg:flex-row">
            ...
            <div class="lg:w-1/2 p-8 md:p-12 flex flex-col justify-center animate__animated animate__slideInRight animate__delay-1s">
...
<section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <?php 
                $delay = 0;
                while($post = mysqli_fetch_assoc($resBlogs)): 
                ?>
                <div class="reveal group cursor-pointer animate__animated" 
                    style="animation-delay: <?php echo $delay; ?>ms;">
                    </div>
                <?php 
                $delay += 200; // Stagger each card by 200ms
                endwhile;
            ?>
